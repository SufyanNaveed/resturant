    ...
    <div class="card card-block">
        ...
        <div class="card-body">
            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <h5><?php echo $this->lang->line('Add New Kitchen') ?></h5>
                <hr>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="kitchen Short Description"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="submit" id="submit-data" class="btn btn-success margin-bottom"
                               value="<?php echo $this->lang->line('Add kitchen') ?>" data-loading-text="Adding...">
                        <input type="hidden" value="kitchen/addkitchen" id="action-url">
                    </div>
                </div>
