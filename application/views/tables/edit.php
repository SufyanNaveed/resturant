        ...
        <div class="card-body">
            ...
            <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control margin-bottom required" name="floor_id">
                            ...
                            <?php if($floors){ foreach($floors as $key=>$floor){ ?>
                                <option value="<?php echo $floor['id'] ?>" <?php echo $floor['id'] == $table['floor_id'] ? 'selected="selected"' : ''; ?>><?php echo $floor['floor_num'] ?></option>
                            <?php } } ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="Table" value="<?php echo $table['table_no'] ?>" class="form-control margin-bottom required" name="table">
                    </div>
                </div>
                <div class="form-group row">
