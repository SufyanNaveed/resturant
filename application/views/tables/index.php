<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('table') ?> <a
                        href="<?php echo base_url('tables/add') ?>"
                        class="btn btn-primary btn-sm rounded">
                    <?php echo $this->lang->line('Add new') ?>
                </a>  <a
                        href="<?php echo base_url('tables') ?>?group=yes"
                    ...
                    <tbody>
                        <?php if($tables) { foreach($tables as $key=>$table){ ?>
                            <tr>
                                ...
                                <td><?php echo $table['floor_num']; ?></td> 
                                <td><?php echo $table['table_no']; ?></td> 
                                <td><?php echo $table['description']; ?></td> 
                                <td>
                                    <a href="<?php echo base_url('tables/edit/'.$table['id'])?>" class="btn btn-primary btn-sm " title='Edit'><span class="fa fa-pencil"></span><?php echo $this->lang->line('edit') ?></a>
                                    <a href="javascript:void(0)" data-object-id='<?php echo $table['id']; ?>' class="btn btn-danger btn-sm delete-object" title='Delete'><span class="fa fa-trash"></span><?php echo $this->lang->line('delete') ?></a>
                                </td> 
                            </tr>
                        <?php } } ?>
                    </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="action-url" value="tables/delete">
