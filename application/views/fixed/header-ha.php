            ...
            if ($this->aauth->premission(2)) { ?>
                <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                    ...
                    <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                    class="dropdown-item dropdown-toggle" href="#" data-toggle="dropdown"><i
                                        class="ft-list"></i> <?php echo 'Recipe Manager' ?></a>
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>recipe/add"
                                                    data-toggle="dropdown"> <?php echo 'New Recipe'; ?></a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>recipe"
                                                    data-toggle="dropdown"><?= 'Manage Recipes'; ?></a>
                                </li>
