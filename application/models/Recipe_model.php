...
class Recipe_model extends CI_Model
{
    ...
    public function addnew($catid, $warehouse, $product_name, $product_code, $product_price, $product_wholesale_price, $factoryprice, $taxrate, $disrate, $product_qty, $product_qty_alert, $product_desc, $image, $unit, $barcode, $v_type, $v_stock, $v_alert, $wdate, $code_type, $w_type = '', $w_stock = '', $w_alert = '', $sub_cat = '', $b_id = '', $serial = '', $recipe_data)
    {
        ...
        if ($this->aauth->get_user()->loc) {
            ...
            foreach ($recipe_data as $key => $val) {
                $recipe_data[$key]['pid'] = $pid;

            }
            // echo '<pre>'; print_r($recipe_data); exit;

            $this->db->insert_batch('geopos_recipe_item', $recipe_data); 
